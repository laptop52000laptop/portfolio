...
export default function NotFound404() {
  return (
<section id="about" className="about section display-height my-0 py-0 pt-4 page_not_found">
   <div>
   ...
   <div className="text">
      ...
      <h2 className='text-white'>Couldn't launch :(</h2>
      <h3 className='text-white'>Page Not Found - lets take you <Link to="/" className='text-danger'>BACK</Link></h3>
   </div>
</section>
    )
}
